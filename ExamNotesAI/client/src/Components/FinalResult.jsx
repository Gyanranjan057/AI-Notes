...
function FinalResult({ result }) {
    ...
    return (
        <div className="mt-6 p-3 space-y-10 bg-white">
            ...
            {quickRevision && <section className="rounded-xl bg-gradient-to-r from-green-100
            ...
            {result.diagram?.data && <section>
                ...
                <p className="mt-3 text-xs text-gray-500 italic">
                    ⬇️ If you need this diagram for future reference or revision,
            ...
            {result.charts?.length > 0 &&
                <section>
                    ...
                    <p className="mt-3 text-xs text-gray-500 italic">
                        ⬇️ If you need this Chart for future reference or revision,
                        you can save it by taking a screenshot.
                    </p>
                </section>}
