...
function Notes() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8">
            ...
            item-statr flex md:items-center justify-between gap-4 flex-col md:flex-row">
           ...
           bg-linear-to-r from-white via-gray-300 to-white bg-clip-text text-transparent">ExamNotes AI</h1>
            ...
            py-2 rounded-full bg-white/10 border border-white/20 text-white text-sm"
           ...
           { !result && <motion.div whileHover={{ scale: 1.02 }}
            ...
            bg-white/60 backdrop-blur-lg border border-dashed
             border-gray-300 text-gay-500 shadow-inner">
