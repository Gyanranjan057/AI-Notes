    ...
    <div className="min-h-screen overflow-hidden
     ...
     <main className="max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
            ...
            <p className="mt-4 text-sm text-gray-500"> Starts with 50 free credits. Upgrade any time for more credits. Instant access</p>
            
        </motion.div>

        {/* RIGHT CONTENT */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8"> 
          <Feature icon="🎁" titel="50 Free Credits" des="Start with 50 credits to generate notes without paying."/>
          <Feature icon="📘" titel=" Exam Notes" des="HIgh-yield, revision-ready exam-oriented notes."/>
          <Feature icon="📂" titel="Project Notes" des="Well-Structured documentation for assignments & projects."/>
          <Feature icon="📊" titel="Charts & Graphs" des="Auto-generated diagrams,charts and flow graphs."/>
          <Feature icon="⬇️" titel="Free PDF Download" des="Download clean printable PDFs instantly."/>
        </div>
